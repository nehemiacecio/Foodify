...
<!--        </div>-->
        <div class="sidebar-brand-text mx-3">Foodify</div>
      </a>
...
<!--
-->
          <li class="nav-item <?php if($page=='Recomendation'){echo 'active';}?>">
              <a class="nav-link" href="<?= base_url('Recomendation'); ?>">
                  <i class="fas fa-fw fa-chart-area"></i>
                  <span>Sistem Rekomendasi</span></a>
          </li>

      <?php endif; ?>
<!--          <li class="nav-item --><?php //if($page=='User'){echo 'active';}?><!--">-->
<!--              <a class="nav-link" href="--><?//= base_url('User/recomendation'); ?><!--">-->
<!--                  <i class="fas fa-fw fa-users-cog"></i>-->
<!--                  <span>Data User</span></a>-->
<!--          </li>-->
